...
class Holidays:
    ...
    def hebrew_to_gregorian(self, year, hebrew_month, hebrew_day, year_is_gregorian=1):
        ...
        if not gd:  # should never occur, but just incase...
            raise RuntimeError("Could not determine gregorian year")
    ...
    def set_thanksgiving(self, year=None):
        ...
        self.time_list[DAY] = self.get_nth_day_of_month(4, THU, NOV, self.time_list[YEAR])
    ...
    def set_election_day(self, year=None):
        ...
        self.time_list[MONTH] = NOV
        self.time_list[DAY] = self.get_nth_day_of_month(1, TUE, NOV, self.time_list[YEAR])
    ...
    def set_presidents_day(self, year=None):
        ...
        self.time_list[MONTH] = NOV
        self.time_list[DAY] = self.get_nth_day_of_month(3, MON, FEB, self.time_list[YEAR])
    ...
    def set_memorial_day(self, year=None):
        ...
        try:
            ...
            self.time_list[DAY] = self.get_nth_day_of_month(5, MON, MAY, self.time_list[YEAR])
        except IndexError:
            # otherwise, May has only 4 Mondays
            self.time_list[DAY] = self.get_nth_day_of_month(4, MON, MAY, self.time_list[YEAR])
    ...
    def set_labor_day(self, year=None):
        ...
        self.time_list[DAY] = self.get_nth_day_of_month(1, MON, SEP, self.time_list[YEAR])
    ...
    def set_columbus_day(self, UnitedStates=1, year=None):
        ...
        if UnitedStates:
            self.time_list[DAY] = self.get_nth_day_of_month(2, MON, OCT, self.time_list[YEAR])
        else:
            self.time_list[DAY] = 12
    ...
    def set_mothers_day(self, year=None):
        ...
        self.time_list[MONTH] = MAY
        self.time_list[DAY] = self.get_nth_day_of_month(2, SUN, MAY, self.time_list[YEAR])
    ...
    def set_fathers_day(self, year=None):
        ...
        self.time_list[MONTH] = JUN
        self.time_list[DAY] = self.get_nth_day_of_month(3, SUN, JUN, self.time_list[YEAR])
    ...
    def set_martin_luther_king_day(self, year=None):
        ...
        self.time_list[MONTH] = JAN
        self.time_list[DAY] = self.get_nth_day_of_month(3, MON, JAN, self.time_list[YEAR])
